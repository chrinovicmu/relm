...
#define CR_ACCESS_CR_NUMBER_CR0     0 
#define CR_ACCESS_CR_NUMBER_CR3     3            
...
int relm_cr0_write_handle_exit(vcpu, exit_qualification);
...
int relm_cr8_access_handle_exit(struct vcpu *vcpu, 
                                uint64_t exit_qual, uint32_t acc_type); 
